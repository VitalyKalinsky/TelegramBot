...
public class Bot extends TelegramLongPollingBot {
    ...
    public String getBotUsername() {
        return "NameIsCarl_bot";
    }

    @Override
    public String getBotToken() {
        return "6349156291:AAFidccAATQg89XtYrOxfdN8DCKQsZHPHk8";
    }
    ...
    private Object runPhotoFilter(Message newMessage) {
        ...
        if (photoMessage != null) {
            ...
            sendMessage.setText("Мы конечно можем долго болтать, но у меня нет на это времени. " +
                    "Отправьте фото и я наложу тот фильтр, который понадобится");
            return sendMessage;
        }
        return null;
    }
